                ...
                {documents.status === "error" ? (
                  ...
                  <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
                    {sectorDocuments.map((document) => {
                      ...
                      return (
                        <article key={`${document.id}-${document.slug}`} className="flex overflow-hidden rounded-lg border border-cni-primary/10 bg-[#f8f9ff]">
                          ...
                          <div className="flex min-w-0 flex-1 flex-col p-4">
                            <p className="font-headline text-xs font-bold uppercase tracking-[0.12em] text-[#168654]">{sector.name}</p>
