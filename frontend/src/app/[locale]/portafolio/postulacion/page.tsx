...
const copy = {
  es: {
    ...
    sectorOptions: ["Agroindustria", "Manufactura", "Turismo", "Energía", "Infraestructura", "Logística y Transporte", "Otros"],
  ...
  en: {
    ...
    sectorOptions: ["Agroindustry", "Manufacturing", "Tourism", "Energy", "Infrastructure", "Logistics and Transportation", "Other"],
