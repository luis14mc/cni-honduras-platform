...
const copy = {
  es: {
    ...
    sectors: [
      ...
      { color: "bg-[#d5e3ff]", label: "Turismo", checked: true },
      { color: "bg-[#708ab5]", label: "Energía", checked: false },
      { color: "bg-[#708ab5]", label: "Manufactura", checked: false },
      { color: "bg-[#708ab5]", label: "Infraestructura", checked: false },
    ],
  ...
  en: {
    ...
    sectors: [
      { color: "bg-[#ffdea5]", label: "Agroindustry", checked: true },
      { color: "bg-[#d5e3ff]", label: "Tourism", checked: true },
      { color: "bg-[#708ab5]", label: "Energy", checked: false },
      { color: "bg-[#708ab5]", label: "Manufacturing", checked: false },
      { color: "bg-[#708ab5]", label: "Infrastructure", checked: false },
    ],
