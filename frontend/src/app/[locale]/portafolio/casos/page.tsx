  ...
  return (
    <div className="-mt-28 flex flex-1 flex-col bg-[#f8f9ff]">
      <section className="relative flex min-h-[50vh] items-center overflow-hidden premium-gradient pt-24">
        <div className="absolute inset-0 bg-[#252A58]/20" />
                ...
                >
                  <div className="relative h-52 bg-[#252A58]">
                    {successStoryHasCover(story) ? (
                      ...
                      <div className="flex h-full items-center justify-center bg-gradient-to-br from-[#252A58] to-[#0E7A7C] px-6 text-center text-sm font-bold uppercase tracking-widest text-white/70">
                        {story.sector?.name ?? story.company_name ?? story.title}
                      </div>
                    )}
                  </div>
                  <div className="p-6">
